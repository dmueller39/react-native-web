...
// Ported from https://github.com/facebook/react-native/blob/c2eb9f468988f7d1db2f7d4e42143547b72bce31/Libraries/Lists/FlatList.js

'use strict';

const React = require('react');
const MetroListView = require('../ListView'); // Used as a fallback legacy option
const View = require('../View');
const VirtualizedList = require('../VirtualizedList');

const invariant = require('fbjs/lib/invariant');

import type {ViewabilityConfig, ViewToken} from '../VirtualizedList/ViewabilityHelper';
